...
class Main {
	public static void main(String[] args) {
		...
		System.out.println("This review gives... " + Review.starRating("src/consumerLab/simpleReview.txt") + " star(s)!");
		System.out.println(Review.totalSentiment("src/consumerLab/26WestReview.txt"));
		System.out.println("This review gives... " + Review.starRating("src/consumerLab/26WestReview.txt") + " star(s)!");
		/*
